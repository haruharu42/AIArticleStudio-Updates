...
SUPPORTED = {"0.4.2.9", "0.4.3.0", "0.4.3.1", "0.4.3.2", "0.4.3.3"}
...
def main() -> None:
    ...
    version_and_hook = (
        ...
        or (version == "0.4.3.3" and activation == "v0432" and text.count(V0432_MARKER) == 1 and text.count(AUTH_MARKER) == 1)
    )
    ...
    result = {
        ...
        "safe_to_update": safe,
        "reason": f"canonical_v{version.replace('.', '')}_verified" if safe else "canonical_v0429_to_v0433_required",
    }

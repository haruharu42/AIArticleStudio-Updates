...
VERSION = "0.4.2.3"
PACKAGE_NAME = "AIArticleStudio_Update_v0.4.2.3_AnimeStyleTuning.zip"
PACKAGE_PATH = ROOT / "updates" / PACKAGE_NAME
STAGE = ROOT / ".build_v0423"
CORE_FILES = ["image_prompt_builder.py"]
RELEASE_FILES = [
    "README.txt",
    "Update.ps1",
    "phase36_v0423_preflight.py",
    "patch_v0423.py",
    "set_version_v0423.py",
    "validate_v0423.py",
]
...
def main() -> None:
    ...
    for name in RELEASE_FILES:
        shutil.copy2(ROOT / "release" / "v0423" / name, STAGE / name)
    ...
    manifest = {
        ...
        "sha256": digest,
        "channel": "preview",
        "notes": "v0.4.2.3: strengthens Anime and Manga image prompts with clear 2D line-art/cel-shading guidance and non-photoreal exclusions.",
    }
    (ROOT / "candidate-v0423.json").write_text(json.dumps(manifest, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    (ROOT / "release" / "v0423" / "SHA256.txt").write_text(digest + "  " + PACKAGE_NAME + "\n", encoding="ascii")

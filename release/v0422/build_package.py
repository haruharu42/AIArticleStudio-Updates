...
VERSION = "0.4.2.2"
PACKAGE_NAME = "AIArticleStudio_Update_v0.4.2.2_ArticleLinkedImages.zip"
PACKAGE_PATH = ROOT / "updates" / PACKAGE_NAME
STAGE = ROOT / ".build_v0422"
CORE_FILES = [
    "image_settings.py",
...
RELEASE_FILES = [
    "README.txt",
    "Update.ps1",
    "phase36_v0422_preflight.py",
    "patch_v0422.py",
    "set_version_v0422.py",
    "validate_v0422.py",
]
...
def main() -> None:
    ...
    for name in RELEASE_FILES:
        shutil.copy2(ROOT / "release" / "v0422" / name, STAGE / name)
    ...
    manifest = {
        ...
        "sha256": digest,
        "channel": "preview",
        "notes": "v0.4.2.2: moves image controls into the Web article preview flow, links prompts to article content, and adds anime/manga plus additional image styles.",
    }
    (ROOT / "candidate-v0422.json").write_text(json.dumps(manifest, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    (ROOT / "release" / "v0422" / "SHA256.txt").write_text(digest + "  " + PACKAGE_NAME + "\n", encoding="ascii")

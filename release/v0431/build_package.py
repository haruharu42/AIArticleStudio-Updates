...
RELEASE_FILES = (
    "README.txt",
    "Update.ps1",
    "phase36_v0431_preflight.py",
    "patch_v0431.py",
    "cleanup_v0431.py",
    "set_version_v0431.py",
    "validate_v0431.py",
)
PAYLOAD_MODULES = ("guided_wizard_v0427.py", "guided_wizard_v0431.py")
FIXED_DATE = (2026, 8, 21, 3, 30, 0)
...
def main() -> None:
    ...
    for name in RELEASE_FILES:
        shutil.copy2(ROOT / "release" / "v0431" / name, STAGE / name)

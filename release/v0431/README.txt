AI Article Studio v0.4.3.1
================================

This update implements the approved interactive six-step preview in the Windows application.
...
- STEP 6 displays a decorated article preview and article-linked image prompts together.

...
def main() -> None:
    ...
    result = {
        ...
        "safe_to_update": safe,
        "reason": (
            f"canonical_v{version.replace('.', '')}_verified"
            if safe
            else "canonical_v0434_v0435_or_v0436_required"
        ),
    }

...
export function AdminHomeTopbar() {
  ...
  return (
    <aside className="admin-home-topbar" aria-label="管理者専用ショートカット">
      <div><span>ADMIN</span><strong>管理者モード</strong><small>運用状況・無料トライアル・販売プロモーションへすぐ移動できます。</small></div>
      <nav><a href="/admin">管理ダッシュボード</a><a href="/admin/free-trial">無料トライアル管理</a><a href="/admin/promotion">販売・SNSプロモーション</a></nav>
    </aside>
  );
}

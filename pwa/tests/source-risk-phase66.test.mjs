...
test("Phase 66 source risk report is admin-only and read-only", async () => {
  const migration = await readRepo("supabase/migrations/20260925002000_knowledge_source_risk_report_v1.sql");

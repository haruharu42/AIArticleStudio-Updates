...
const FAQ_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      ["SNS投稿文も作れますか？", "はい。X、Instagram、Threads向けの投稿プロンプトを作成できます。記事からSNS向けに展開する使い方もできます。"],
  ...
  },
  {
    title: "PWA・ナビ・表示",
    items: [
      ["下部ナビの項目は変更できますか？", "はい。設定画面の「下部ナビをカスタマイズ」から、中央3枠まで好きな機能を選び、左右へ並べ替えられます。ホームと設定は固定です。"],
      ["下部ナビを消すことはできますか？", "設定の「下部ナビを常に表示」をOFFにすると、ホームと設定以外の画面では下部ナビを隠せます。"],
      ["ナビ設定は別の端末にも同期されますか？", "現在のナビ表示・並び順は、その端末のPWA／ブラウザに保存されます。別端末ではそれぞれ設定してください。"],

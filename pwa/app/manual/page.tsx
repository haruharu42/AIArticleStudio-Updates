...
const MANUAL_SECTIONS = [
  {
    ...
    group: "基本",
    title: "ホーム",
    when: "副業や目的から使う機能を探したい時、今日やることや最近の作業を確認したい時。",
    lead: "AASの入口です。「副業から探す」「やりたいことから探す」から必要な機能へ進み、記事・SNS・画像・副業支援をまとめて確認します。",
    points: [
      "note副業、SNS運用、記事・コンテンツ販売、AI副業探しなどから入口を選べます。",
      "目的が決まっている場合は、記事・SNS・画像・アカウント設計・プロンプトなどの機能へ直接進めます。",
      "最近の記事やnote運営の今日の予定など、既存の運営情報も引き続き確認できます。",
    ],
  ...
  },
  {
    ...
    group: "副業支援",
    title: "副業プロンプトライブラリ",
    when: "AIに何を頼めばよいか分からない時、用途別の完成プロンプトをすぐ作りたい時。",
    lead: "記事・SNS・YouTube・画像・アフィリエイト・物販・受託・リサーチなどからテンプレートを選び、必要な情報だけ入力して使います。",
    points: [
      "検索または用途カテゴリからテンプレートを選びます。",
      "テーマ、想定する相手、目的、追加条件など必要な情報だけ入力します。",
      "完成プロンプトは自動更新され、そのままコピーできます。",
      "「コピーしてChatGPT / Claude / Geminiを開く」から外部AIへ移動できます。",
      "よく使うテンプレートはお気に入り、使用したものは最近使ったものとして端末内にアカウント別で保持します。",
      "AASは外部AIのAPIキーや秘密鍵をブラウザへ保存しません。",
      "管理者が公開したクラウドテンプレートを優先し、通信できない場合は内蔵テンプレートへ安全に切り替わります。",
      "外部AIへ移動する前に、選択中プロンプトと入力内容を端末内へアカウント別で保存します。",
    ],
    links: [{ href: "/prompts", label: "副業プロンプトライブラリを開く" }],
  },
  {
    id: "create",
    group: "記事制作",
  ...
  },
  {
    ...
    group: "運営自動化",
    title: "AAS運営コックピット",
    when: "今日やることをまとめたい時、完成記事を公開前に確認したい時、公開記事をSNSへ再利用したい時、複数記事をシリーズ化したい時。",
    lead: "note運営予定・記事ライブラリ・公開状態・シリーズ計画をつなぎ、記事の作成前から公開後までを1つの画面で管理します。",
    points: [
      "「今日やること」では、その日のnote予定、下書き、公開準備、SNS再利用、進行中シリーズから優先タスクを自動整理します。",
      "「公開前チェック」では、タイトル、本文、未処理メモ、有料価格、公開URL、画像マーカー、外部リンク、数値・実績表現などを自動確認します。AASは最終的な公開可否を断定せず、人が確認します。",
      "必要に応じて公開前レビュー用プロンプトをChatGPT / Gemini / Claudeへ渡し、変動情報は最新の公式情報を調査させます。",
      "「記事→SNS再利用」では、X・Threads・Instagram・TikTok・YouTube Shortsごとに目標文字数と公開後の日数を変え、初回告知と再告知を作れます。",
      "「シリーズ設計」では、AIに無料/有料の役割と記事順を含むJSONを作らせ、AASへ読み込んでクラウド保存します。シリーズ内の記事はタイトル・テーマを引き継いで記事作成へ進めます。",
    ],
    links: [{ href: "/workflow", label: "運営コックピットを開く" }],
  },
  {
    id: "presets",
    group: "記事制作",
  ...
  },
  {
    ...
    points: [
      ...
      "保存済みアカウント設計は記事プロンプトへ自動反映され、記事作成画面の「記事条件にも反映」からジャンル・読者・主なテーマも画面上の記事条件へ反映できます。",
    ],
  ...
  },
  {
    ...
    points: [
      ...
      "activeな管理者だけ、AAS自体のnote運営に使う「AAS運営用プロフィール設定」を表示します。ジャンル・運営スタイル・読者・トーン・収益化方針・主なテーマを一括反映でき、一般ユーザーには表示されません。",
